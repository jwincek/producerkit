...
add_action('wp_abilities_api_categories_init', function (): void {
    ...
    wp_register_ability_category('farm-preorders', [
        'label'       => __('Farm Pre-Orders', 'farm-stand-manager'),
        'description' => __('Abilities for creating and managing pay-at-pickup pre-orders.', 'farm-stand-manager'),
    ]);
});
...
add_action('wp_abilities_api_init', function (): void {
    ...
    wp_register_ability('farm-stand-manager/create-preorder', [
        'label'       => __('Create Pre-Order', 'farm-stand-manager'),
        'description' => __('Place a pay-at-pickup pre-order for farm products: product lines with quantities, a pickup date within the next month, and contact details. Returns a cancellation token.', 'farm-stand-manager'),
        ...
        'input_schema' => [
            ...
            'properties' => [
                ...
                'pickup_date' => ['type' => 'string',  'description' => 'Pickup date (YYYY-MM-DD), today through +30 days.'],
                'location_id' => ['type' => 'integer', 'description' => 'Optional pickup location post ID.'],
                'email'       => ['type' => 'string',  'description' => 'Optional email for confirmation.'],
                'phone'       => ['type' => 'string',  'description' => 'Optional phone number.'],
                'note'        => ['type' => 'string',  'description' => 'Optional note to the farm.'],
            ],
    ...
    wp_register_ability('farm-stand-manager/list-preorders', [
        'label'       => __('List Pre-Orders', 'farm-stand-manager'),
        'description' => __('Retrieve pre-orders, optionally filtered by status (pending, confirmed, ready, picked_up, cancelled). Staff only.', 'farm-stand-manager'),
        'category'    => 'farm-preorders',
        'execute_callback' => function (array $input = []): array {
        ...
        'input_schema' => [
            'type'       => 'object',
            'properties' => [
                'status' => ['type' => 'string',  'description' => 'Filter by status.', 'enum' => array_merge([''], Orders\valid_statuses())],
    ...
    wp_register_ability('farm-stand-manager/update-preorder-status', [
        ...
        'input_schema' => [
            'type'       => 'object',
            'properties' => [
                'id'     => ['type' => 'integer', 'description' => 'Pre-order ID.'],
                'status' => ['type' => 'string',  'description' => 'New status.', 'enum' => Orders\valid_statuses()],
            ],
            'required' => ['id', 'status'],
        ],
        'output_schema' => [
