...
final class PickupDatesTest extends WP_UnitTestCase {
    ...
    public function set_up(): void {
        ...
        $this->product  = self::factory()->post->create(['post_type' => 'lfuf_product', 'post_status' => 'publish']);
        $this->location = self::factory()->post->create(['post_type' => 'lfuf_location', 'post_status' => 'publish']);

        // Saturday-only schedule, generous season.
        update_post_meta($this->location, '_lfuf_ss_schedule', wp_json_encode([['day' => 6, 'open' => '09:00', 'close' => '16:00']]));
