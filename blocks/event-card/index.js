	...
	registerBlockType( 'lfuf/event-card', {
		edit: function EditEventCard( props ) {
			...
			const blockProps = useBlockProps( {
				className: 'lfuf-event-card-wrapper',
			} );
			...
			if ( loading ) {
				return el(
					...
					el(
						...
						el(
							'div',
							{ className: 'lfuf-event-card-wrapper__loading' },
							el( Spinner ),
							' Loading event\u2026'
						)
					)
						...
						el(
							...
							dt.date
								? el(
										...
										{
											className:
												'lfuf-event-card__datetime',
										},
										el(
											'span',
											{
												className:
													'lfuf-event-card__date',
											},
											dt.date
										),
										dt.time
