...
* Added: when two businesses share one site, products and events now say which one made them. The wording follows the trade of whoever published it — a farm's reads "Grown by", a bakery's "Baked by" — followed by the business name you set on your own user profile. Nothing appears at all on a site with a single producer.
